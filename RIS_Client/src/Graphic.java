...
public class Graphic extends JFrame implements KeyListener {
	...
	public boolean fastMapCollisionCheck(GameObject playerOldPos, GameObject playerNewPos) {
		GameObject player_old = playerOldPos;
		GameObject new_player = playerNewPos;
		LinkedList<GameObject> worldcopy = new LinkedList<GameObject>(world.getWorld());
		boolean collision = collisionDetection.detect(player_old, new_player, worldcopy, world.getCache(), true);
	...
	public void keyPressed(KeyEvent e) {
		if (e.getKeyCode() == KeyEvent.VK_LEFT) {
			...
			GameObject oldPlayer = new GameObject(playerID, player.getPosx(), player.getPosy(),player.getCollisonRadius(), false);
			GameObject newPlayer = new GameObject(playerID, player.getPosx()-playerSpeed, player.getPosy(),player.getCollisonRadius(), false);
			...
			GameObject oldPlayer = new GameObject(playerID, player.getPosx(), player.getPosy(), player.getCollisonRadius(), false);
			GameObject newPlayer = new GameObject(playerID, player.getPosx(), player.getPosy()+playerSpeed,player.getCollisonRadius(), false);
